# Generated by Django 5.2.3 on 2025-10-01 19:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome', models.CharField(max_length=255)),
                ('tipo', models.CharField(choices=[('senior', 'Acampamento Sênior'), ('juvenil', 'Acampamento Juvenil'), ('mirim', 'Acampamento Mirim'), ('servos', 'Acampamento de Servos'), ('casais', 'Encontro de Casais'), ('evento', 'Evento'), ('retiro', 'Retiro')], max_length=20)),
                ...
                ('paroquia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='eventos', to='inscricoes.paroquia')),
            ],
        ),
        migrations.CreateModel(
            name='Grupo',
            fields=[
                ...
                ('cor', models.CharField(blank=True, help_text='Ex.: Amarelo, Vermelho, Azul...', max_length=20, null=True)),
                ('evento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='grupos', to='inscricoes.eventoacampamento')),
            ],
        ),
        migrations.CreateModel(
            name='Inscricao',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='inscricoes', to='inscricoes.grupo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ministerios', to='inscricoes.eventoacampamento')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_alocacao', models.DateTimeField(auto_now_add=True)),
                ('inscricao', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='alocacao_ministerio', to='inscricoes.inscricao')),
                ('ministerio', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='inscricoes', to='inscricoes.ministerio')),
            ],
        ),
        migrations.CreateModel(
            name='Pagamento',
        ...
        migrations.AddConstraint(
            model_name='grupo',
            constraint=models.UniqueConstraint(fields=('evento', 'nome'), name='uniq_grupo_nome_por_evento'),
        ),
        migrations.AddConstraint(
            model_name='ministerio',
            constraint=models.UniqueConstraint(fields=('evento', 'nome'), name='uniq_ministerio_nome_por_evento'),
        ),
        migrations.AddConstraint(
